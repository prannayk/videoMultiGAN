...
import sys
import time
from generator import large_generator as generate
...
gan = VAEGAN(batch_size=batch_size, embedding_size=embedding_size, image_shape=[64,64,1], motion_size=motion_size,  
