...
def discriminator(train_input,dropout,reuse=False):
	with tf.variable_scope("D",reuse=reuse):
		...
		# final output layer
		output = tf.nn.softmax(tf.matmul(hidden6,weight7) + bias7)
	return output, [weight1,weight2,weight3,weight4,weight5,weight6,weight7,bias1,bias2,bias3,bias4,bias5,bias6,bias7]
